...
LEGAL_PAGES = {
    "privacy": {"heading": "Privacy Policy", "intro": "How MahaUpdate handles information.", "content": "<h2>Information we collect</h2><p>MahaUpdate does not require accounts and does not ask visitors to provide personal information through this website.</p><h2>Cookies and third parties</h2><p>Your browser may store preferences locally. Hosting providers, analytics services, or advertising services may use cookies if they are enabled in the future. This policy will be updated if services that collect personal information are added.</p><h2>Official links</h2><p>MahaUpdate links to external official websites. Their privacy practices are governed by their own policies.</p><h2>Contact</h2><p>Contact MahaUpdate at <a href=\"mailto:contact.mahaupdates@gmail.com\">contact.mahaupdates@gmail.com</a>.</p>"},
    ...
    "contact": {"heading": "Contact MahaUpdate", "intro": "Contact information and official-source guidance.", "content": "<p>For general website enquiries, email <a href=\"mailto:contact.mahaupdates@gmail.com\">contact.mahaupdates@gmail.com</a>.</p><p>For questions about a recruitment notice, result, exam or application, please use the official department link shown with that update. The relevant government department is the authoritative contact for its notification.</p>"},
}
